# A.7.1 MUSE DataIMmov v4.1

his module is originally integrated within the MUSE-Data v4.0 module.
However, in this section an updated standalone version of the module is provided, intended for interaction with PPG and fNIRS sensors (v4.1).

The user manual remains the same as the one corresponding to A.4.2 MUSE-DataIMmov v4.0.

For clarity in the structural organization and modular division of the repository, this updated version is presented as an independent section.
